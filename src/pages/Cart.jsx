...
const Cart = () => {
    const { products, currency, cartItems, updateCartItem, removeFromCart, getCartCount, getCartAmount, navigate } = useAppContext();
        ...
        <div className="flex flex-col md:flex-row justify-center  mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={() => { navigate("/products"); scrollTo(0, 0) }} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <img src={assets.arrow_right_icon_colored} alt="arrow_right_icon_colored" className="group-hover:-translate-x-1 transition" />
                    Continue Shopping
                </button>
